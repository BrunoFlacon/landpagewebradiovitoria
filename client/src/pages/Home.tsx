      ...
      {menuOpen && (
        <div className="md:hidden bg-[#0b1e3d]/98 backdrop-blur-md border-t border-white/10">
          <div className="container py-4 flex flex-col gap-3">
            ...
            <button
              onClick={() => scrollTo("#contato")}
              className="bg-[#c9a227] text-[#0b1e3d] font-bold text-sm px-5 py-3 rounded-full mt-2"
            >
              Fale Conosco
            </button>
          </div>
          ...
          {services.map((service, i) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mt-4 flex items-center gap-2 text-[#c9a227] text-sm font-semibold group cursor-pointer" style={{ fontFamily: "'Lato', sans-serif" }}>
                  Saiba mais
          ...
          <div>
            ...
            <div className="mt-10">
              ...
              <div className="flex gap-3">
                {[
                  { icon: <Facebook className="w-5 h-5" />, href: "https://facebook.com/webradiovitoria" },
                  { icon: <Instagram className="w-5 h-5" />, href: "https://instagram.com/webradiovitoriaa" },
                  { icon: <Youtube className="w-5 h-5" />, href: "https://youtube.com/@webradiovitoria" },
                  { icon: <Twitter className="w-5 h-5" />, href: "https://x.com/WebRadi0Vitoria" },
                ].map((social, i) => (
                  <a
                    key={i}
                    href={social.href}
